...
class Piece 
  ...
  def self.rotations (point_array)
    rotate1 = point_array.map {|x,y| [-y,x]}  # clockwise 90 degree
    rotate2 = point_array.map {|x,y| [-x,-y]} # clockwise 2 * 90 degree
    rotate3 = point_array.map {|x,y| [y,-x]}  # clockwise 3 * 90 degree
